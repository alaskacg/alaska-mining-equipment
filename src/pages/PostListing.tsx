...
import MiningFooter from "@/components/mining/MiningFooter";
...
import { Upload, X, Gift, Loader2, Sparkles, Mail, AlertTriangle } from "lucide-react";
...
const alaskaLocations = [
  ...
  { value: "barrow", label: "Barrow/Utqiagvik" },
  { value: "valdez", label: "Valdez" },
  { value: "homer", label: "Homer" },
  { value: "seward", label: "Seward" },
  { value: "palmer", label: "Palmer" },
  { value: "prudhoe-bay", label: "Prudhoe Bay" },
  { value: "other", label: "Other Alaska Location" },
];
...
const PostListing = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!isEmailVerified) {
      toast({
        ...
        description: "Please verify your email address to post listings.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      // Sync to main hub (fire and forget - don't block on failure)
      if (listing) {
        supabase.functions.invoke('sync-to-hub', {
          body: { listing_id: listing.id }
        }).then(({ error }) => {
          if (error) console.error('Hub sync failed:', error);
          else console.log('Listing synced to hub');
        });
      }
  ...
  if (authLoading || betaLoading || loadingCategories) {
    return (
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              Fill out the form below to create your listing. Active for 60 days!
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Please verify your email address to post listings. Check your inbox for the verification email.
                    </p>
                  </div>
                </div>
              </div>
