...
import { ArrowRight, Clock, Image, Video, Gift } from "lucide-react";
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-4 max-w-2xl mx-auto">
            Reach thousands of Alaskans looking for boats. List your boat for <strong className="text-accent">FREE!</strong>
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-glass rounded-2xl p-6 text-center border-2 border-accent/50 relative">
              ...
              <p className="text-muted-foreground text-sm">Free listing</p>
            </div>
